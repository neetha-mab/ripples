      ...
      <section className={styles.about_page}>
        <div className={styles.container}>
          <div className={styles.about_blocks}>
            <h2>Who we are – Your trusted Ripples expert</h2>
            <p>Devoted to the far-away North Atlantic, Ripples Adventure ApS has set its heart and mind into exploring and discovering the beauty of Greenland, Iceland and the Faroe Islands.</p>
            <p>Our main values and beliefs are “Honesty, Speciality and Responsibility”. Driven by the pursuit of growing expertise and better service, we have spent more than 35 marvellous years designing tours to Greenland, Iceland and the Faroe Island. In 2019, we expand our business to B2C, and we are confident that we will build a solid connection between customers and our adventures in the Ripples.</p>

            <p>We are determined to provide the best service and Ripples adventure for you. “Knowledgeable, Responsible, and Flexible” are the criteria for Ripples Adventure guides. If you choose an excursion operated by Ripples Adventure guides, you can fully trust and rely on their professional attitude. Meet the Ripples Adventure Guides <Link href={"#"}>here.</Link></p>

            <p>The blue Ripples Adventure logo and the red uniform of the guides are and always will be the symbol of good service and the trusted expert in Greenland, Iceland and Faroe Islands.</p>
          </div>
          <section className={styles.about_blocks}>
            <h2>What we do<br/>Passionate about Greenland since 1983</h2>
            <p>Ripples Adventure ApS offers the most comprehensive range of tours and activities to Greenland. Our business covers both B2B and B2C sections. Whether you are a traveller who is searching for new adventures or a travel agent looking for tours beyond the ordinary, you can always find the services we provide satisfying.</p>
            ...
            <p>We connect local sights to customers and develop our excursions. With trusted suppliers and experienced Ripples Adventure guides, we provide high-quality single-day excursions with good service.</p>
            ...
            <p>Your unforgettable Ripples Adventure is just one click away.</p>
            ...
            <p>Our experienced travel consultant and the itinerary designer will be happy to help you. Make the Ripples adventure in your dream come true by contacting us.</p>
            ...
            <p>Apart from our well-designed tours, we also offer travel information, equipment lists and local tips to prepare you as much as possible before you arrive in the Ripples. Local stories and blogs can also draw you closer to Greenland.</p>
            <p>You don’t need to search, browse and compare travel products and information from millions of websites opened in your browser anymore. The Ripples Adventure official website is good enough.</p>

            <h4>Gallery</h4>
            <p>Marvel at the fantastic photos and videos about Greenland, Iceland and the Faroe Islands.</p>
            <p>Gigantic icebergs, long and narrow ice fjords, vast tundra land, dancing northern lights, and different Ripples creatures. You can’t help but be amazed by the beauty of nature, lively towns, and people who are living there.</p>
